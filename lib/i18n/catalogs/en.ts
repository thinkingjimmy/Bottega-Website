...
export const en = {
  ...
  home: {
    ...
    agents: {
      ...
      handoff: { eyebrow: "Handoff", title: "Plan with one Agent. Build with another.", body: "Claude frames the problem and writes the Plan, then sends it to a Chat where Codex builds it. When Codex is done, the result comes back to the original Chat on its own — for Claude to review, or to hand to the next Agent." },
    ...
    trust: {
      ...
      source: {
        eyebrow: "Open source",
        title: "Open source. Release your own version.",
        body: "Every line is MIT-licensed, the encryption included. Read it, change it, and ship your own build.",
        fork: "Fork on GitHub",
    ...
    apps: {
      ...
      dock: {
        eyebrow: "Dock",
        title: "Your Apps, on their own Dock.",
        body: "Every App Bottega builds lands on Bottega Dock, one click from open. It sits above the macOS Dock without changing a thing on your Mac — or takes its place, if you prefer one bar.",
        points: ["One click opens any Bottega App", "The macOS Dock stays as it is", "Finder, Downloads and Mac apps fit alongside"],
      },
      widgets: {
        eyebrow: "Widgets",
        title: "Widgets you build yourself.",
        body: "The Dock holds widgets, too, and you make them the way you make Apps: describe one, and your Agent builds it. Start with AI Limits — what’s left of every Agent’s plan — or ask for one that tracks a budget or this week’s workouts.",
        cases: ["Codex, Claude and Kimi, side by side", "Tokens and estimated cost for today", "This month’s total from Expense Tracker", "Days in a row, from Fitness Log"],
      },
    },
    faq: {
      eyebrow: "FAQ",
      title: "Questions, answered.",
      lede: "Something else? The people who build Bottega read every issue.",
      issues: "Ask on GitHub",
      items: [
        { question: "Is Bottega free?", answer: "Yes. The app is free to use and open source under the MIT license, and you run it with the Agent plans you already pay for. Sync is free during the public beta; it will become a paid option later." },
        { question: "Which Agents does it work with?", answer: "Codex, Claude Code, Kimi Code and OpenCode, each through its official CLI. Hermes, Pi and DeepSeek are next." },
  ...
  demo: {
    ...
    handoff: { sent: "Plan goes to Codex", back: "The result comes back" },
    ...
    widgets: { limits: "AI Limits", usage: "AI Usage", spend: "Monthly spend", streak: "Workout streak", leftInWindow: "Left in this window", today: "Today", tokens: "tokens", estimatedCost: "≈ {cost} estimated cost", inMonth: "in September", month: "September", streakUnit: "days in a row", days: "days" },
    chats: {
      releaseNotes: {
