...
export const es = {
  ...
  home: {
    hero: {
      ...
      date: "Mar 1 sep  9:36",
      chatChip: "Como Codex, pero mejor",
      appChip: "Apps creadas por tu Agent",
    },
    agents: {
      eyebrow: "Agentes",
      title: ["Trae los Agentes que ya usas.", "Conserva el plan que ya pagas."],
      lede: "Codex, Claude Code, Kimi Code y OpenCode se ejecutan dentro de Bottega a través de sus CLI oficiales, con tus propias cuentas: un comando cada uno, y comparten una misma barra lateral. Sin tokens revendidos, sin recargo, sin nada nuevo que contratar.",
      roster: {
        codex: "La CLI oficial de Codex con tu cuenta, sus modelos y su escalera de permisos.",
        claude: "Claude Code tal como está instalado en tu máquina: tu suscripción, sus modelos, el modo Plan.",
        kimi: "La CLI de Kimi Code con la cuenta que ya usas, en la misma barra lateral.",
        opencode: "OpenCode y el catálogo de proveedores que configuraste, sin mover el trabajo.",
        more: "Y más",
        soon: "Próximamente",
        moreBody: "Hermes, Pi y DeepSeek son los siguientes: cada uno con su propia CLI, nunca a través de un proxy.",
      },
      handoff: { eyebrow: "Relevo", title: "Pasa el trabajo de un Agente al siguiente.", body: "¿Se agotó la cuota de un plan? Elige otro Agente para el siguiente turno y sigue en el mismo Chat. O reparte el trabajo a propósito: Claude escribe el plan, Codex lo implementa, Kimi ejecuta las pruebas; cada salto es un Chat en tu barra lateral, no un paso en un archivo de flujo de trabajo.", note: "Cada Agente también puede ejecutar varios subagentes en paralelo." },
      data: { eyebrow: "Espacio de datos", title: "Un espacio de datos, compartido por todos los Agentes.", body: "Lo que un Agente registra, el siguiente lo lee. Base guarda los registros de cada conversación en un único espacio de datos local y muestra los mismos registros como tabla, gráfico, galería o mapa, así que el contexto no se reinicia cuando cambia el Agente." },
    },
    trust: {
      eyebrow: "Local primero · Sincronización cifrada",
      title: ["Tuyo, en tu máquina.", "Cifrado en todo lo demás."],
      lede: "Bottega guarda tu trabajo en una carpeta que puedes abrir, ejecuta los Agentes con sus CLI oficiales y se publica bajo licencia MIT. Activa la sincronización cuando quieras: solo viaja texto cifrado.",
      claims: [
        { title: "Una carpeta, no una caja negra", body: "Chats, adjuntos, Proyectos, Base, el código de las Apps y los Skills son archivos en una carpeta que tú eliges: legibles sin Bottega y respaldados con solo copiarla." },
        { title: "CLI oficiales, tus cuentas", body: "Cada Agente se ejecuta con su propia CLI, con tu sesión iniciada. Bottega añade el espacio de trabajo, nunca un proxy en medio." },
        { title: "Código abierto, MIT", body: "El código que toca tus datos es público. Léelo, audítalo, haz un fork." },
        { title: "Cifrado antes de salir", body: "La sincronización está desactivada hasta que la actives. Cuando está activa, los Chats se sellan con una contraseña que solo tú conoces; el servidor solo guarda texto cifrado." },
      ],
      sync: { eyebrow: "Sincronización y control remoto", title: "Sincronización cifrada de extremo a extremo, con tu teléfono al mando.", body: "Activa la sincronización y tus Chats te siguen a la Web y al teléfono, cifrados con una contraseña que solo tú conoces antes de salir del ordenador. Desde el teléfono, envía una tarea al ordenador, mira la salida en directo, aprueba, detén, pregunta más. Los servidores de Bottega almacenan y retransmiten texto cifrado; nunca leen un mensaje." },
    },
    apps: {
      eyebrow: "Apps · Dock · Widgets",
      title: ["Crea Apps nativas de IA.", "Tenlas siempre a un clic."],
      lede: "Describe una App y Bottega la construye: los datos, la interfaz, los permisos. Fíjala en Bottega Dock, junto al resto de tu Mac, y deja que los widgets vigilen tus planes de IA mientras trabajas.",
      cells: [
        { title: "Apps", tag: "describir → construir → cambiar", body: "Di lo que necesitas y obtén una App que funciona, con sus propios datos e interfaz. Cámbiala de la misma manera: conversando." },
        { title: "Bottega Dock", tag: "en lugar del Dock o a su lado", body: "Una barra en la parte inferior de la pantalla para tus Apps, el Finder, Descargas y la Papelera. El Dock del sistema siempre está a un clic." },
        { title: "Widgets", tag: "en vivo · ocultables al compartir", body: "Los límites de IA y el uso de hoy, directamente en el Dock. Los anillos se vuelven naranjas cuando a un plan le queda poco." },
      ],
      build: { eyebrow: "Apps", title: "Descríbela. Bottega la construye.", body: "Un entrenador de fitness con IA, un registro de gastos con IA o algo completamente tuyo. Bottega convierte la idea en una App que funciona, de los datos a la interfaz. Se incluyen cuatro Apps:" },
      dock: {
        eyebrow: "Dock",
        title: "Cada App a un clic.",
        body: "Bottega Dock se sitúa en la parte inferior de la pantalla con tus Apps, el Finder, Descargas y la Papelera. Deja que sustituya al Dock del sistema o úsalos juntos. Nada cambia en tu Mac hasta que lo confirmes, y el Dock del sistema vuelve con un clic.",
        points: ["Fija las Apps de Bottega junto a tus apps del Mac", "Ocultar automáticamente o mostrar siempre", "Una sola disposición, sincronizada entre tus Mac"],
      },
      widgets: {
        eyebrow: "Widgets",
        title: "Tus planes de IA, de un vistazo.",
        body: "Los widgets viven en el Dock. Límites de IA dibuja lo que queda del plan de cada Agente como un anillo, que se vuelve naranja cuando queda poco; haz clic para ver cada ventana y su hora de reinicio. Uso de IA cuenta los tokens de hoy y su coste estimado.",
        cases: ["Codex, Claude, Kimi y OpenCode, uno junto a otro", "Tokens y coste estimado de hoy"],
        privacy: "¿Compartes pantalla? Un solo interruptor muestra •• en lugar de cada número.",
      },
    },
    source: {
      eyebrow: "Código abierto",
      title: "Publica tu propia versión.",
      lede: "Bottega tiene licencia MIT. Haz un fork del repositorio, cambia lo que quieras y publica tu propia versión: la compilación de abajo es toda la ceremonia.",
      terminalLabel: "Comandos de terminal para compilar Bottega",
      cloned: "Bottega clonado en ./Bottega",
      installed: "Dependencias instaladas",
      items: [
        { title: "Cambia la interfaz.", body: "Rediseña cualquier superficie; el tema es un solo archivo de tokens." },
        { title: "Añade un Agente.", body: "Conecta otra CLI a través del mismo adaptador ACP." },
        { title: "Publica tu propia compilación.", body: "Fírmala, cámbiale el nombre y distribúyela como tuya." },
      ],
  ...
  features: {
    ...
    agents: {
      metaTitle: "Codex y Claude Code en un mismo escritorio",
      metaDescription: "Usa los CLI oficiales de Codex, Claude Code, Kimi Code y OpenCode en Bottega. Conserva tus suscripciones y pasa el trabajo de un Chat a otro.",
      label: "Agents",
    ...
    apps: {
      metaTitle: "Crea aplicaciones con tus agentes de IA",
      metaDescription: "Crea e instala apps de IA con interfaz, datos y permisos propios. Explora el lienzo de diseño, el Kanban y los registros de gastos y ejercicio.",
      label: "Apps",
    ...
    customizable: {
      metaTitle: "Personaliza tus apps por Chat con IA",
      metaDescription: "Describe tus cambios a un agente de IA en el proyecto fuente de tu app Bottega. Actualiza el código y recompila la app en el mismo espacio.",
    ...
    base: {
      metaTitle: "Base: datos locales y seis vistas con IA",
      metaDescription: "Organiza datos locales por Chat en Bottega Base. Explora los mismos registros como tabla, lista, Kanban, gráfico, galería o mapa en Chats y apps.",
      label: "Base",
      ...
      sections: [
        {
          ...
          paragraphs: [
            "Lleva tus gastos, organiza un inventario o crea una lista de tareas. Dile a tu Agent qué necesitas: puede crear los campos y registros en Base, y añadirlos o actualizarlos cuando se lo pidas.",
            "Después, pregunta «¿Qué tareas siguen pendientes?» o «¿Cuánto gasté este mes?». Tu Agent puede consultar y resumir los registros directamente, con los datos a la vista junto a la conversación.",
          ],
          points: [],
        },
        {
          heading: "Seis vistas, los mismos registros",
          paragraphs: ["Usa una tabla o lista para los detalles, un tablero kanban para el progreso, un gráfico para las tendencias, una galería para los archivos multimedia o un mapa para las ubicaciones. Todas las vistas siguen conectadas a los mismos registros."],
          points: ["Filtra, ordena y agrupa registros para centrarte en lo que importa.", "Calcula valores con fórmulas y conecta registros mediante relaciones.", "Adjunta archivos multimedia y consulta el historial de cada registro.", "Importa y exporta archivos CSV, JSON y XLSX."],
        },
        {
          heading: "Sigue trabajando con los datos que creas",
          paragraphs: [
            "Usa una Base para un solo Chat o comparte la Base de un Project entre sus Chats. Puedes retomar los mismos registros a medida que avanza el trabajo.",
            "Las Apps pueden ofrecer una interfaz personalizada sobre una Base. Usa la App para tu tarea y abre su pestaña Data cuando quieras consultar o trabajar con los registros que la alimentan.",
            "Base guarda tus registros localmente. Las Apps reciben permisos separados para leer, añadir, modificar o eliminar registros y trabajar con adjuntos. Cada actualización comprueba los cambios recientes para evitar que una edición antigua los sobrescriba.",
          ],
          points: [],
        },
        {
  ...
  demo: {
    ...
    fitness: {
      ...
      search: "Buscar", searchHint: "Nombre, alias, músculo o equipo", bodyPart: "Parte del cuerpo", muscleRegion: "Región muscular", equipment: "Equipo", all: "Todo", exercises: "1324 ejercicios", showing: "Mostrando 1–24", groups: ["Pecho", "Piernas superiores", "Espalda", "Hombros", "Brazos"],
    },
    handoff: { chats: ["Unificar la barra de nav", "Implementación de nav", "Regresión de nav"], ask: "Mueve las llamadas de la navegación al componente compartido.", divider: "A partir de aquí responde {agent}", undo: "Deshacer", usageLimit: "Límite de uso" },
    sync: { device: "MacBook Pro", phone: "iPhone", ask: "Aprueba el plan y escríbelo.", handledOn: "Gestionado en {device}", editing: "Editando CHANGELOG.md", encrypted: "Cifrado de extremo a extremo · retransmitido cifrado", runningOn: "Ahora se ejecuta en {device}" },
    widgets: { limits: "Límites de IA", usage: "Uso de IA", updated: "Actualizado ahora", left: "Queda un {percent} %", window: "Ventana de 5 h · se reinicia a las {time}", weekly: "Semanal", tokensToday: "tokens hoy" },
    chats: {
      releaseNotes: {
        prior: { ask: "De las PR fusionadas desde 0.1.9, ¿cuáles notaría de verdad un usuario?", worked: "22s", reply: "Seis de las dieciocho. La paridad de Agentes es la que se sentirá primero; las dos refactorizaciones internas caben en una línea." },
