...
export const es = {
  ...
  home: {
    ...
    agents: {
      ...
      handoff: { eyebrow: "Relevo", title: "Un Agente planifica. Otro construye.", body: "Claude plantea el problema y escribe el Plan, y luego lo envía a un Chat donde Codex lo construye. Cuando Codex termina, el resultado vuelve solo al Chat original, para que Claude lo revise o se lo pase al siguiente Agente." },
    ...
    trust: {
      ...
      source: {
        ...
        title: "Código abierto. Publica tu propia versión.",
        body: "Cada línea tiene licencia MIT, el cifrado incluido. Léelo, cámbialo y publica tu propia build.",
        fork: "Haz fork en GitHub",
        browse: "Ver el código",
    ...
    apps: {
      ...
      dock: {
        eyebrow: "Dock",
        title: "Tus Apps, en un Dock propio.",
        body: "Cada App que Bottega construye va a Bottega Dock y se abre con un clic. Se coloca encima del Dock de macOS sin cambiar nada de tu Mac, o lo reemplaza si prefieres una sola barra.",
        points: ["Un clic abre cualquier App de Bottega", "El Dock de macOS queda tal cual", "Finder, Descargas y apps de Mac al lado"],
      },
      widgets: {
        eyebrow: "Widgets",
        title: "Widgets que creas tú.",
        body: "El Dock también tiene widgets, y los creas igual que las Apps: describe uno y tu Agente lo construye. Empieza con Límites de IA —lo que queda del plan de cada Agente— o pide uno que siga un presupuesto o los entrenamientos de la semana.",
        cases: ["Codex, Claude y Kimi, lado a lado", "Tokens y coste estimado de hoy", "El total del mes en Control de gastos", "Días seguidos, desde el Registro de entrenamiento"],
      },
    },
    faq: {
      eyebrow: "Preguntas frecuentes",
      title: "Preguntas, respondidas.",
      lede: "¿Algo más? Quienes construyen Bottega leen cada issue.",
      issues: "Pregunta en GitHub",
      items: [
        { question: "¿Bottega es gratis?", answer: "Sí. La App es gratuita y de código abierto con licencia MIT, y la usas con los planes de Agente que ya pagas. La sincronización es gratuita durante la beta pública; más adelante será de pago." },
        { question: "¿Con qué Agentes funciona?", answer: "Codex, Claude Code, Kimi Code y OpenCode, cada uno mediante su CLI oficial. Hermes, Pi y DeepSeek vienen después." },
  ...
  demo: {
    ...
    handoff: { sent: "El Plan pasa a Codex", back: "El resultado vuelve" },
    ...
    widgets: { limits: "Límites de IA", usage: "Uso de IA", spend: "Gasto del mes", streak: "Racha de entrenamiento", leftInWindow: "Queda en esta ventana", today: "Hoy", tokens: "tokens", estimatedCost: "≈ {cost} de coste estimado", inMonth: "en septiembre", month: "Septiembre", streakUnit: "días seguidos", days: "días" },
    chats: {
      releaseNotes: {
