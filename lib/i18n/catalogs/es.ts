...
export const es = {
  ...
  footer: {
    noteBefore: "Bottega es software libre y de código abierto (",
    noteAfter: ").",
  ...
  home: {
    hero: {
      ...
      date: "Mar 1 sep  9:36",
      chatChip: "Un Chat tan directo como tu CLI",
      appChip: "Apps creadas por tu Agent",
    },
    agents: {
      title: "Todos los Agents que pagas, en una sola barra lateral.",
      paragraphs: [
        "Codex, Claude, Kimi y OpenCode viven juntos en Bottega: las CLI oficiales que ya tienes instaladas, sin reimplementaciones.",
        "Cada uno funciona con tu propia suscripción: el plan que ya pagas, facturado por el proveedor y no por nosotros.",
      ],
    },
    apps: {
      title: "Crea Apps nativas para la IA.",
      body: "Crea un entrenador personal con IA, un registro de gastos o algo completamente nuevo. Describe la idea y Bottega la convierte en una App funcional, desde los datos hasta la interfaz. Estas son las cuatro Apps incluidas con Bottega:",
    },
    customizable: {
      title: "Personaliza cualquier App conversando.",
      body: "Cada App de Bottega tiene código fuente editable; no es una caja negra. Elige Edit App y describe lo que quieres cambiar. Tu Agent trabaja directamente con el código para actualizar funciones, datos e interfaz, sin necesidad de otro editor.",
    },
    base: {
      title: "Cada Chat incluye una Base.",
      body: "Bottega la usa para estructurar, analizar y visualizar tus datos. Pide totales, resúmenes, desgloses o tendencias y explora los mismos datos como tabla, gráfico, galería o mapa. No hace falta exportar.",
    },
    fork: {
      title: "Haz un Fork. Publica tu propia versión.",
      body: "Bottega usa la licencia MIT de principio a fin. Haz Fork del repositorio, cambia los Agents, las herramientas y la interfaz, y distribuye tu versión a todo el equipo. Seguirá ejecutándose de forma local en sus equipos y con las suscripciones que ya pagan.",
  ...
  features: {
    ...
    agents: {
      ...
      title: "Varios Agents. Un solo espacio de trabajo.",
      deck: "Ejecuta Codex, Claude Code, Kimi Code y OpenCode en un mismo espacio local, con sus CLI oficiales, tus accesos existentes y una experiencia de conversación compartida.",
    },
    apps: {
      label: "Apps",
    ...
    agentsArticle: {
      stories: [
        ...
        },
        {
          ...
          title: "Una experiencia común, adaptada sin aplanarla.",
          paragraphs: [
            "Respuestas en streaming, actividad de herramientas, revisión de Plan, preguntas, permisos, modelos y mensajes en cola comparten un sistema visual. Bottega traduce el protocolo de cada backend sin fingir que sus capacidades son idénticas.",
            "La matriz muestra el contrato actual. «Compartido» significa que la superficie de Bottega es la misma; Nativo y Adaptado muestran diferencias. Una capacidad ausente en ejecución no aparece como control muerto.",
          ],
        },
        {
          index: "03 · Colaboración entre Agents",
          title: "Deja que un Agent entregue el trabajo a otro.",
          paragraphs: [
            "Una conversación de Claude puede preparar un Plan, enviar el contexto limitado a una conversación de Codex y pedirle que lo implemente. Codex puede devolver el resultado a la conversación original para revisión.",
            "La entrega usa las herramientas persistentes de comunicación Chat de Bottega: el Chat de destino conserva su Agent y espacio, el mensaje empieza o espera allí, y el resultado sigue visible y reutilizable en vez de desaparecer dentro de una ejecución oculta.",
          ],
        },
      ],
    },
  ...
  demo: {
    ...
    apps: { shapes: ["App de artefacto del espacio · GUI aislada", "Base App · 9 columnas · tareas / hallazgos / libro", "Base App · 4 columnas · vistas detalle / análisis", "Base App con GUI · mapa de calor muscular"] },
    baseViews: [
    ...
    agentsVisual: {
      ...
      rows: [
        { label: "Respuestas en streaming", values: ["Compartido", "Compartido", "Compartido", "Compartido"] }, { label: "Actividad de herramientas", values: ["Compartido", "Compartido", "Compartido", "Compartido"] },
        { label: "Plan + revisión", values: ["Nativo", "Nativo", "Nativo", "Adaptado"] }, { label: "Preguntas", values: ["UI común", "UI común", "UI común", "UI común"] },
        { label: "Selector de modelo", values: ["Completo", "Lista", "Lista", "Lista"] }, { label: "Permisos", values: ["3 niveles", "2 niveles", "2 niveles", "2 niveles"] },
        { label: "Mensaje durante el turno", values: ["En vivo", "En vivo", "Turno siguiente", "Turno siguiente"] },
      ],
      collaborationLabel: "Claude planifica, Codex implementa y Claude revisa mediante entregas Chat persistentes", persistentChats: "CHATS PERSISTENTES", flowTitle: "Planificar → implementar → revisar", visibleHandoff: "Entrega visible",
      phases: ["01 · PLAN", "02 · IMPLEMENTACIÓN", "03 · REVISIÓN"], planSummary: "Plan de implementación de navegación", planItems: ["Usar el límite del Header compartido", "Conservar el comportamiento móvil", "Verificar rutas estáticas"],
      filesChanged: "3 archivos modificados", typecheckPassed: "Comprobación de tipos superada", implementationComplete: "Implementación completa", noIssues: "Sin problemas bloqueantes", reviewMatch: "La intención del Plan coincide con la implementación.", reviewReturned: "Revisión devuelta",
    },
  },
