...
export const fr = {
  ...
  footer: {
    noteBefore: "Bottega est libre et open source (",
    noteAfter: ").",
  ...
  home: {
    hero: {
      ...
      chatChip: "Un Chat aussi direct que votre CLI",
      appChip: "Les Apps créées par votre Agent",
    },
    agents: {
      title: "Tous les Agents que vous payez, dans une seule barre latérale.",
      paragraphs: [
        "Codex, Claude, Kimi et OpenCode vivent tous dans Bottega — avec les CLI officielles déjà installées, sans réimplémentation.",
        "Chacun utilise votre propre abonnement : le forfait que vous payez déjà, facturé par le fournisseur, pas par nous.",
      ],
    },
    apps: {
      title: "Créez des Apps natives pour l’IA.",
      body: "Créez un coach sportif IA, un suivi de dépenses IA ou quelque chose d’entièrement nouveau. Décrivez l’idée : Bottega la transforme en App fonctionnelle, des données jusqu’à l’interface. Voici les quatre Apps fournies avec Bottega :",
    },
    customizable: {
      title: "Personnalisez chaque App par la conversation.",
      body: "Chaque App Bottega possède un code source modifiable, pas une boîte noire. Choisissez Edit App et décrivez le changement voulu. Votre Agent travaille directement sur la source pour mettre à jour fonctions, données et interface, sans éditeur de code séparé.",
    },
    base: {
      title: "Chaque Chat dispose d’une Base.",
      body: "Bottega l’utilise pour structurer, analyser et visualiser vos données. Demandez des totaux, des résumés, des répartitions ou des tendances, puis explorez les mêmes données en table, graphique, galerie ou carte. Aucun export nécessaire.",
    },
    fork: {
      title: "Forkez-le. Livrez votre propre version.",
      body: "Bottega est sous licence MIT de bout en bout. Forkez le dépôt, changez les Agents, les outils et l’interface, puis déployez votre version auprès de toute l’équipe. Elle reste locale sur leurs machines et utilise les abonnements qu’ils paient déjà.",
  ...
  features: {
    ...
    agents: {
      ...
      title: "Plusieurs Agents. Un seul espace de travail.",
      deck: "Exécutez Codex, Claude Code, Kimi Code et OpenCode dans un même espace local, avec leurs CLI officielles, vos accès existants et une expérience de conversation commune.",
    },
    apps: {
      label: "Apps",
    ...
    base: {
      label: "Base",
      menuCopy: "Des données locales structurées près de la conversation",
      title: "Des données locales structurées à côté de chaque conversation.",
      deck: "Une Base est la couche de données en lignes de Bottega pour les Chats, Projects et Apps orientées données, placée près de la conversation qui l’utilise.",
      imageAlt: "Onglet Data d’une App Bottega montrant une table Base avec vues, filtres, colonnes, groupes et ajout de ligne",
      imageCaption: "Capture de Bottega : la même page d’App passe de sa GUI à un workbench Base complet.",
      sections: [
        {
          heading: "La conversation et le jeu de données partagent un propriétaire",
          paragraphs: [
            "Un Chat peut utiliser sa propre Base locale. S’il n’en possède pas et appartient à un Project, il peut utiliser la Base partagée du Project. La règle de propriété est explicite : l’Agent et l’interface agissent sur le même jeu de données durable.",
            "Les Agents reçoivent des outils Base intégrés pour lire schéma et lignes, interroger, agréger et effectuer des modifications contrôlées par révision. Un suivi, un inventaire, un registre ou un plan devient ainsi structuré sans créer de feuille de calcul séparée.",
          ],
          points: [],
        },
        {
          heading: "Six vues, une seule source de vérité",
          paragraphs: ["Table, List, Kanban, Map, Chart et Gallery sont des projections des mêmes lignes. Changer de vue ne duplique pas les données dans des documents distincts."],
          points: ["Filtrez, triez, regroupez et choisissez les champs visibles sans réécrire les enregistrements.", "Utilisez formules et relations pour les données dérivées ou liées.", "Joignez des médias, inspectez l’historique et échangez des données CSV, JSON ou XLSX.", "Laissez une App fournir une GUI adaptée tout en gardant sa Base disponible dans l’onglet Data."],
        },
        {
          heading: "Un accès volontairement étroit",
          paragraphs: [
            "L’accès d’une App à une Base est limité par capacité pour une génération précise. Lecture, insertion, modification, suppression et pièces jointes sont des droits distincts ; les contrôles de révision empêchent une écriture obsolète d’écraser les données récentes.",
            "Les Agents peuvent ainsi utiliser une surface de données locale sans transformer chaque interface installée en client de base de données sans limites.",
          ],
          points: [],
        },
      ],
    ...
    agentsArticle: {
      stories: [
        ...
        },
        {
          ...
          title: "Une expérience commune, adaptée sans être aplatie.",
          paragraphs: [
            "Réponses en continu, activité des outils, revue de Plan, questions, autorisations, modèles et messages en attente partagent un système visuel. Bottega traduit le protocole de chaque backend sans prétendre que leurs capacités sont identiques.",
            "La matrice montre le contrat actuel. « Partagé » signifie que la surface Bottega est la même ; Natif et Adapté indiquent les différences. Une capacité absente à l’exécution ne devient pas un contrôle inerte.",
          ],
        },
        {
          index: "03 · Collaboration entre Agents",
          title: "Laissez un Agent transmettre le travail à un autre.",
          paragraphs: [
            "Une conversation Claude peut préparer un Plan, envoyer le contexte limité à une conversation Codex et lui demander l’implémentation. Codex peut ensuite renvoyer le résultat à la conversation d’origine pour revue.",
            "La transmission utilise les outils de communication Chat persistants de Bottega : le Chat cible garde son Agent et son espace, le message y démarre ou y attend, et le résultat reste visible et réutilisable au lieu de disparaître dans une exécution cachée.",
          ],
        },
      ],
    },
  ...
  demo: {
    ...
    apps: { shapes: ["App artefact d’espace · GUI isolée", "Base App · 9 colonnes · tâches / constats / registre", "Base App · 4 colonnes · vues détail / analyse", "Base App avec GUI · carte thermique musculaire"] },
    baseViews: [
    ...
    agentsVisual: {
      ...
      rows: [
        { label: "Réponses en continu", values: ["Partagé", "Partagé", "Partagé", "Partagé"] }, { label: "Activité des outils", values: ["Partagé", "Partagé", "Partagé", "Partagé"] },
        { label: "Plan + revue", values: ["Natif", "Natif", "Natif", "Adapté"] }, { label: "Questions", values: ["UI partagée", "UI partagée", "UI partagée", "UI partagée"] },
        { label: "Sélecteur de modèle", values: ["Complet", "Liste", "Liste", "Liste"] }, { label: "Autorisations", values: ["3 niveaux", "2 niveaux", "2 niveaux", "2 niveaux"] },
        { label: "Message en cours de tour", values: ["Direct", "Direct", "Tour suivant", "Tour suivant"] },
      ],
      collaborationLabel: "Claude planifie, Codex implémente et Claude révise au moyen de transmissions Chat persistantes", persistentChats: "CHATS PERSISTANTS", flowTitle: "Planifier → implémenter → réviser", visibleHandoff: "Transmission visible",
      phases: ["01 · PLAN", "02 · IMPLÉMENTATION", "03 · REVUE"], planSummary: "Plan d’implémentation de la navigation", planItems: ["Utiliser la limite du Header partagé", "Préserver le comportement mobile", "Vérifier les routes statiques"],
      filesChanged: "3 fichiers modifiés", typecheckPassed: "Vérification des types réussie", implementationComplete: "Implémentation terminée", noIssues: "Aucun problème bloquant", reviewMatch: "L’intention du Plan et l’implémentation correspondent.", reviewReturned: "Revue renvoyée",
    },
  },
