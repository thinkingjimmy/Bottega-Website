...
export const fr = {
  ...
  home: {
    ...
    agents: {
      ...
      handoff: { eyebrow: "Passage de relais", title: "Un Agent planifie. Un autre construit.", body: "Claude pose le problème et rédige le Plan, puis l’envoie dans un Chat où Codex le construit. Quand Codex a fini, le résultat revient tout seul dans le Chat d’origine — pour que Claude le relise, ou le passe à l’Agent suivant." },
    ...
    trust: {
      ...
      source: {
        eyebrow: "Open source",
        title: "Open source. Publiez votre propre version.",
        body: "Chaque ligne est sous licence MIT, chiffrement compris. Lisez-la, modifiez-la, publiez votre propre build.",
        fork: "Forker sur GitHub",
        browse: "Parcourir le code",
        license: "Licence MIT",
    ...
    apps: {
      ...
      dock: {
        eyebrow: "Dock",
        title: "Vos Apps, dans leur propre Dock.",
        body: "Chaque App que Bottega construit rejoint Bottega Dock et s’ouvre en un clic. Il se place au-dessus du Dock de macOS sans rien changer à votre Mac — ou le remplace, si vous préférez une seule barre.",
        points: ["Un clic ouvre n’importe quelle App Bottega", "Le Dock de macOS reste tel quel", "Finder, Téléchargements et apps Mac à côté"],
      },
      widgets: {
        eyebrow: "Widgets",
        title: "Des widgets que vous créez vous-même.",
        body: "Le Dock accueille aussi des widgets, et vous les créez comme des Apps : décrivez-en un, votre Agent le construit. Commencez par Limites IA — ce qu’il reste du forfait de chaque Agent — ou demandez-en un qui suit un budget ou les séances de la semaine.",
        cases: ["Codex, Claude et Kimi, côte à côte", "Jetons et coût estimé du jour", "Le total du mois dans Suivi des dépenses", "Jours d’affilée, depuis le Journal d’entraînement"],
      },
    },
    faq: {
      eyebrow: "FAQ",
      title: "Vos questions, nos réponses.",
      lede: "Autre chose ? Les personnes qui construisent Bottega lisent chaque issue.",
      issues: "Posez la question sur GitHub",
      items: [
        { question: "Bottega est-il gratuit ?", answer: "Oui. L’App est gratuite et open source sous licence MIT, et vous l’utilisez avec les forfaits d’Agent que vous payez déjà. La synchronisation est gratuite pendant la bêta publique ; elle deviendra payante par la suite." },
        { question: "Avec quels Agents fonctionne-t-il ?", answer: "Codex, Claude Code, Kimi Code et OpenCode, chacun via sa CLI officielle. Hermes, Pi et DeepSeek suivent." },
  ...
  features: {
    ...
    apps: {
      ...
      screenshot: {
        alt: "Bibliothèque Apps de Bottega montrant Bottega Design Canvas installé et marqué Ready",
        caption: "Capture de Bottega : une App installée possède une place durable dans la bibliothèque et un état de préparation explicite.",
      },
      sections: [
        {
    ...
    customizable: {
      ...
      screenshot: {
        alt: "Écran de détail de Bottega Design Canvas avec onglets App et Data, réglages, Chat et menu d’actions",
        caption: "Capture de Bottega : la page d’une App réunit sa surface, ses données, son Chat d’utilisation, ses réglages et ses actions source.",
      },
      sections: [
        {
  ...
  demo: {
    chrome: {
      ...
      ledger: "Registre", analysis: "Analyse", date: "Date", amount: "Montant", category: "Catégorie", note: "Note", sum: "Somme", ready: "Prête", appTab: "App", dataTab: "Données",
    ...
    ledger: {
      ...
      categoryShare: "Répartition par catégorie", dailySpend: "Dépenses quotidiennes", topExpenses: "Dépenses les plus élevées", receipt: "Reçu", location: "Position", where: "Lieu", label: "Libellé",
    },
    kanban: {
    ...
    handoff: { sent: "Le Plan part chez Codex", back: "Le résultat revient" },
    ...
    widgets: { limits: "Limites IA", usage: "Utilisation IA", spend: "Dépenses du mois", streak: "Série d’entraînements", leftInWindow: "Reste dans la fenêtre", today: "Aujourd’hui", tokens: "jetons", estimatedCost: "≈ {cost} de coût estimé", inMonth: "en septembre", month: "Septembre", streakUnit: "jours d’affilée", days: "jours" },
    chats: {
      releaseNotes: {
    ...
    baseVisual: {
      schemaLabel:
        "Un reçu envoyé dans un Chat, et la ligne que Base en tire dans la colonne voisine",
      chatLedger: "Dépenses",
      askReceipt: "Enregistre ce reçu.",
      replyReceipt: "Enregistré — {row}.",
      typesLabel: "Types de colonne",
      columnTypes: [
        "Texte", "Nombre", "Date", "Sélection", "Case à cocher",
        "URL", "Localisation", "Pièce jointe", "Formule", "Relation",
      ],
      schemaCaption:
        "Base est la troisième colonne du Chat, pas une fenêtre à part. Les noms d’outils sont ceux du produit : base_describe lit les colonnes et la révision courante, base_insert_rows écrit la ligne sous un identifiant fourni par l’appelant. Ce registre utilise quatre des dix types de colonne ci-dessous.",
      viewsLabel:
        "Une même Base qui passe de sa vue tableau à liste, kanban, carte, graphique et galerie",
      viewNames: ["Tableau", "Liste", "Kanban", "Carte", "Graphique", "Galerie"],
      viewsCaption:
        "Six types de vue, pas un de plus : table, list, kanban, map, chart, gallery. Rien sous la barre d’onglets n’est une copie : chaque vue lit les mêmes dix-huit lignes, plus un filtre, un tri et un peu de configuration. Le kanban groupe par la colonne de sélection, la carte s’appuie sur la colonne de position, la galerie sur la colonne de pièce jointe.",
      chatsLabel:
        "Trois images d’un même espace de travail : un Chat qui enregistre un reçu, la Base de Project où la ligne atterrit, et un second Chat qui y relit le total du mois",
      chatMonthly: "Dépenses du mois",
      askMonthly: "Combien ai-je dépensé le mois dernier ?",
      replyMonthly: "{count} entrées, {sum} au total.",
      baseOwner: "Une même Base de Project",
      noteFile: "Donnez le reçu —\nl’Agent écrit la ligne",
      noteStore: "La ligne atterrit dans Base,\npas dans ce Chat",
      noteReuse: "Reposez la question depuis un autre Chat",
      noteSame: "et le total est relu\ndans ces mêmes lignes",
      chatsCaption:
        "Trois images du même espace de travail, de haut en bas. Hors écriture manuscrite, tout est le texte du produit : la ligne citée dans la première réponse est la première ligne de la Base en dessous, et le total de la dernière réponse est la ligne de synthèse de cette Base — le second Chat ne reçoit pas la réponse, il la lit.",
    },
  },
