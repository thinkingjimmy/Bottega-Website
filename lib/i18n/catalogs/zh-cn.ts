...
export const zhCN = {
  ...
  home: {
    ...
    agents: {
      ...
      handoff: { eyebrow: "交接", title: "把工作从一个 Agent 交给下一个。", body: "某个套餐的额度用完了？给下一轮换一个 Agent，在同一条 Chat 里继续。或者有意分工：Claude 出计划，Codex 做实现，Kimi 跑测试——每一次交接都是侧栏里的一条 Chat，而不是工作流文件里的一步。", note: "每个 Agent 还能并行跑多个 Subagent。" },
    ...
    source: {
      eyebrow: "开源",
      title: "发布你自己的版本。",
      lede: "Bottega 以 MIT 协议开源。fork 仓库、改成你想要的样子、发布你自己的版本——下面这几行就是全部仪式。",
      terminalLabel: "构建 Bottega 的终端命令",
      cloned: "已把 Bottega 克隆到 ./Bottega",
      installed: "依赖已安装",
      items: [
        { title: "改界面。", body: "任何表面都能重绘；主题就是一个 token 文件。" },
        { title: "加一个 Agent。", body: "通过同一个 ACP 适配器接入另一个 CLI。" },
        { title: "发布你自己的构建。", body: "签名、改名、当作你自己的产品分发。" },
      ],
      license: "MIT 许可",
