...
export const zhCN = {
  ...
  home: {
    ...
    customizable: {
      title: "通过对话定制任何 App。",
      body: "每个 Bottega App 都有可编辑源码。点击 Edit App，描述你想改变什么；Agent 会直接修改代码，更新功能、数据与界面，无需另开代码编辑器。",
    },
    base: {
      title: "每个 Chat，一个数据空间。",
      body: "对话中的信息会沉淀到 Base。让 Agent 直接整理、汇总和分析，再用表格、图表、画廊或地图查看同一份数据，无需导出。",
    },
    fork: {
      title: "发布你自己的版本。",
