          ...
          <div className="vw-stage">
            ...
            <div className="vw-pane">
              <div className="vw-head">
                ...
                <span className="k-date">{chrome.date}</span>
                <span className="k-amt">{chrome.amount}</span>
                <span className="k-cat">{chrome.category}</span>
                <span className="k-note">{chrome.note}</span>
            ...
            <div className="vw-pane">
              <div className="vw-charts">
                ...
                <div className="ch">
                  <div className="ch-h">{demo.copy.ledger.dailySpend}</div>
                  <div className="ch-b">
            ...
            <div className="vw-pane">
              <div className="vw-cfg">
                <span>
                  {demo.copy.ledger.location}
                  <b>
                    {demo.copy.ledger.where}
                    <Stroke d={D.chevronDown} size={11} width={1.8} />
                  </b>
                </span>
                <span>
                  {demo.copy.ledger.label}
                  <b>
                    {chrome.category}
                    <Stroke d={D.chevronDown} size={11} width={1.8} />
                  </b>
