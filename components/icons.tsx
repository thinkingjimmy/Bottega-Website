...
export const D = {
  ...
  /* Apps 页与 App 独立窗口那几枚：卡片右上角的钉、页头右端的两颗开关、
     入口那行的刷新。逐枚取自产品用的 lucide（Pin / Settings2 /
     MessageSquare / RefreshCw），圆点一律写成两段弧，与同族共用描边规则。 */
  ...
  settings2: "M20 7h-9M14 17H5M20 17a3 3 0 1 1-6 0 3 3 0 0 1 6 0M10 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0",
  ...
  /* 单张图片，与 images 分开：产品里 attachment 列用的是 lucide 的
     Image，Gallery 页签用的是 Images——两枚形近，混用会让「列类型」与
     「视图类型」读成同一件事。 */
  image: "M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zM9 11a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm12 4-3.09-3.09a2 2 0 0 0-2.82 0L6 21",
